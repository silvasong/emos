...
<head>
<meta charset="utf-8"/>
<title><s:message code="loglist.adminuserlog"/></title>
...
<body class="page-header-fixed">
			...
			<div class="page-content">								
				<!-- BEGIN PAGE TITLE & BREADCRUMB-->
				 <div class="page-bar">
					<%--<ul class="page-breadcrumb">
						...
						<li>
							<a href="<c:url value="/"/>managerlog"><s:message code="loglist.adminuserlog"/></a>
						</li>
					</ul>--%>					
				</div> 
				...
				<div class="modal" id="view_log" tabindex="-1" data-width="760">
					<div class="modal-header">
						...
						<h4 class="modal-title"><s:message code="loglist.adminuserlog.tablename"/></h4>
					</div>
	...
	<script src="${pageContext.request.contextPath}/static/js/managerlogTableData.js"></script>
	<script>
	jQuery(document).ready(function() {       
	   Metronic.init(); // init metronic core components
	   Layout.init(); // init current layout	
	   //Demo.init(); // init demo features
	   ManagerLogTable.init("<c:url value="/"/>","${sessionScope.locale}");	   
	});
	</script>
