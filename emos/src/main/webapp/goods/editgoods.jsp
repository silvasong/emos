			...
			<div class="page-content">
				...
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i><s:message code="product.edittable.title"/>
						</div>
					</div>
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<div class="col-md-5">
																	...
																	<form:hidden path="productName_locale[${status.index}].localeId"  />													                
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<div class="col-md-5">
																	...
																	<form:hidden path="shortDescr_locale[${status.index}].localeId"  />																																	
																</div>
															</div>
														</div>
													</div>
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<div class="col-md-8">																																		
																	...
																	<form:hidden path="fullDescr_locale[${status.index}].localeId"  />																
														...
														<div class="col-md-12">															
															<div class="form-group">
																...
																<div class="col-md-5">
																	...
																	<form:hidden path="unitName_locale[${status.index}].localeId"  />
																</div>
															</div>
														</div>
													</div>
								...
								<div class="row">
									<div class="col-md-6">										
										<div class="form-group">
											...
											<div class="col-md-9">
												<form:select path="menu.menuId" cssClass="form-control" name="menu" >
