...
<head>
<meta charset="utf-8"/>
<title><s:message code="msg.title"/></title>
...
<body class="page-header-fixed">
		...
		<div class="page-content-wrapper">	
			<div class="page-content">								
				...
				<div class="portlet-body" >
					<form id="searchForm" name="searchForm" action="msg" class="form-horizontal" method="post">
				
				<div class="row">
						<div class="col-md-6">	
							<div class="form-group">
								<label class="col-md-3 control-label"><s:message code="msg.user.name"/></label>
								<div class="col-md-9">
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue-hoki">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i><s:message code="msg.title"></s:message>
								</div>
								<%-- <div class="actions">									
								...
								<table class="table table-striped table-hover table-bordered" id="mylog_table">
									<thead>
										<tr>
											...
											<th><s:message code="msg.user.name"/></th>
											<th><s:message code="msg.phone"/></th>
											<th><s:message code="msg.content"/></th>
											<th><s:message code="msg.create.time"/></th>
	...
	<script src="../static/js/msgTableData.js"></script>
	<script>
